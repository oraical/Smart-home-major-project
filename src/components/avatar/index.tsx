...
const Avatar = ({ children }: Props) => {
  return (
    <div className="row-start-1 gap-1 mx-auto text-white bg-delft lg:w-full lg:col-span-full ">
      {children}
    </div>
  );
};
...
Avatar.Details = function avatarDetails() {
  return (
    <div className="flex flex-col items-end justify-center ">
      <h2 className="font-bold lg:text-md">Krishnendu</h2>
      <div className="flex">
        <FiMapPin />
        <span className="ml-2 text-sm lg:text-base ">Amtala, South 24 PGS</span>
      </div>
    </div>
  );
};
