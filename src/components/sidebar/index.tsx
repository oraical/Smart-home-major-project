...
const SideBar = ({ children }: Props) => {
  return (
    <div className="lg:row-start-2 bg-rosy lg:mx-0 lg:col-start-3">
      {children}
    </div>
  );
};
    ...
    <div className="self-start w-full mt-6 md:w-1/5 lg:w-full">
      ...
      <div className="flex justify-center gap-2 py-2 bg-white rounded-lg md:flex-col md:items-center lg:flex-row">
        <div className="flex flex-col items-center justify-center p-2">
          ...
          <p className="mt-1 text-xs font-bold lg:text-sm">Hulk</p>
        </div>
        <div className="flex flex-col items-center justify-center p-2">
          <div className="p-2 text-black rounded-full bg-bgDarker">
            <IoPersonCircle />
          ...
          <p className="mt-1 text-xs font-bold lg:text-sm">Thor</p>
        </div>
        <div className="flex flex-col items-center justify-center p-2">
          <div className="p-2 text-black rounded-full bg-bgDarker">
            <IoPersonCircle />
          </div>
          <p className="mt-1 text-xs font-bold lg:text-sm">Lord</p>
        </div>
      </div>
    </div>
  );
